...
class MyLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      "default_shake_message": "No need to shake now !",
      "edit_step": "Edit step",
      "edit_user": "Edit user",
      ...
      "settings": "Settings",
      "media": "Media",
      "shake_message": "Message displayed on shake",
    ...
    'fr': {
      ...
      "default_shake_message": "Inutile de secouer maintenant !",
      ...
      "settings": "Paramètres",
      "media": "Média",
      "shake_message": "Message affiché lors d'une secousse",
